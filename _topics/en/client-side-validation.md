...
two commitment schemes: **tapret**, which hides commitments as
unspendable leaves in taproot's script tree, and **opret**, which
embeds commitments in an OP_RETURN output.
